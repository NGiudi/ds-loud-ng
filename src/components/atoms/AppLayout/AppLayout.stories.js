...
import { Icon, Text, ThemeDS } from "../../../";

import { ContentBox, MainContent, SideBarButton, TopBar } from "./AppLayout";
...
export const LayoutExample = () => {
  return (
    <ThemeDS>
      <TopBar padding="y-8 l-24">Logotipo</TopBar>

      <MainContent>
        {/*TODO: scroll de sidebar si se extiend mucho.*/}
        <SideBar>
          <SideBarButton>
            <Icon margin="r-8" size="sm" />
            <Text>Home</Text>
          </SideBarButton>

          <SideBarButton>
            <Icon icon="ghost" margin="r-8" size="sm" />
            <Text>Juegos</Text>
          </SideBarButton>

          <SideBarButton>
            <Icon icon="cog" margin="r-8" size="sm" />
        ...
        <ContentBox>
          ...
          <Text margin="b-8" weight="bold">
            Section 1.10.32 of &quot;de Finibus Bonorum et Malorum&ldquo;,
          ...
          <Text margin="b-8" weight="bold">
            Section 1.10.33 of &quot;de Finibus Bonorum et Malorum&ldquo;,
            written by Cicero in 45 BC
          </Text>
