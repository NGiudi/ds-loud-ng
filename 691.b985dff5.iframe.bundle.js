...
`},Dropdown=props=>{const{children,name,onSelect}=props,[optionSelected,setOptionSelected]=(0,react.useState)(null),[showPanel,setShowPanel]=(0,react.useState)(!1),innerRef=(0,useOuterClick.x)((()=>{showPanel&&toogleShowPanel()})),toogleShowPanel=()=>{setShowPanel((prev=>!prev))},getPanel=react.Children.toArray(children)[1],getToggle=react.Children.toArray(children)[0];return(0,jsx_runtime.jsxs)(Dropdown_styles_Styles.DropdownWrapper,{ref:innerRef,children:[react.cloneElement(getToggle,{onClick:toogleShowPanel,openPanel:showPanel}),react.cloneElement(getPanel,{name,onSelect:(value,name)=>{toogleShowPanel(),value!==optionSelected&&(onSelect&&onSelect(value,name),setOptionSelected(value))},showPanel})]})};Dropdown.displayName="Dropdown",Dropdown.propTypes={children:prop_types_default().node,name:prop_types_default().string,onSelect:prop_types_default().func},Dropdown.defaultProps={children:null,name:null,onSelect:()=>{}},Dropdown.__docgenInfo={description:"",methods:[],displayName:"Dropdown",props:{children:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"node"},required:!1},name:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"string"},required:!1},onSelect:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1}}};const ItemWrapper=(0,styled_components_browser_esm.Ay)("div")`
  ...
  `}
`,DropdownItem=props=>{const{disabled,name,onSelect,value}=props;return(0,jsx_runtime.jsx)(ItemWrapper,{onClick:()=>{disabled||onSelect&&onSelect(value,name)},...props})};DropdownItem.displayName="DropdownItem",DropdownItem.propTypes={disabled:prop_types_default().bool,name:prop_types_default().string,onSelect:prop_types_default().func,value:prop_types_default().any},DropdownItem.defaultProps={disabled:!1,name:null,onSelect:()=>{},value:null},DropdownItem.__docgenInfo={description:"",methods:[],displayName:"DropdownItem",props:{disabled:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},name:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"string"},required:!1},onSelect:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1},value:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"any"},required:!1}}};const TriangleWrapper=(0,styled_components_browser_esm.Ay)("div")`
  ${props=>styled_components_browser_esm.AH`
...
`,Wrapper:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>styled_components_browser_esm.AH`
    ${(0,spacing.O)(props)}
  `};
`},Input=props=>{const{description,icon,id,label,name,type}=props,[showPassword,setShowPassword]=(0,react.useState)(!1);return(0,jsx_runtime.jsxs)(Input_styles_Styles.Wrapper,{$margin:props.margin,children:[!!label&&(0,jsx_runtime.jsx)(src.EY,{as:"label",htmlFor:id,margin:"b-4",type:"bodySemibold",children:label}),!!description&&(0,jsx_runtime.jsx)(src.EY,{color:"black_400",margin:"b-4",type:"captionRegular",children:description}),(0,jsx_runtime.jsxs)(Input_styles_Styles.InputWrapper,{ref:props.reference,children:[!!icon&&(0,jsx_runtime.jsx)(src.In,{icon,margin:"r-8",size:"sm"}),(0,jsx_runtime.jsx)(Input_styles_Styles.InputStyles,{autoComplete:props.autoComplete,autoFocus:props.autoFocus,id,disabled:props.disabled,innerRef:props.innerRef,name,onKeyPress:props.onKeyPress,placeholder:props.placeholder,readOnly:props.readOnly,type:showPassword?"text":type}),"password"===type&&(0,jsx_runtime.jsx)(ShowPasswordButton,{onClick:()=>{setShowPassword((prev=>!prev))},show:showPassword})]}),(0,jsx_runtime.jsx)(Input_styles_Styles.ErrorWrapper,{$margin:"l-4 t-4",children:(0,jsx_runtime.jsx)(Input_styles_Styles.Error,{component:"div",name})})]})};Input.displayName="Input",Input.propTypes={autoComplete:prop_types_default().string,autoFocus:prop_types_default().bool,description:prop_types_default().string,disabled:prop_types_default().bool,icon:prop_types_default().string,id:prop_types_default().string,innerRef:prop_types_default().oneOfType([prop_types_default().object,prop_types_default().func]),label:prop_types_default().string,margin:prop_types_default().string,name:prop_types_default().string.isRequired,onKeyPress:prop_types_default().func,placeholder:prop_types_default().string,readOnly:prop_types_default().bool,reference:prop_types_default().oneOfType([prop_types_default().object,prop_types_default().func]),type:prop_types_default().oneOf(["number","password","text"])},Input.defaultProps={autoComplete:"off",autoFocus:!1,description:"",disabled:!1,icon:null,id:null,innerRef:null,label:"",margin:"a-0",name:"",onKeyPress:()=>{},placeholder:"",readOnly:!1,reference:null,type:"text"},Input.__docgenInfo={description:"",methods:[],displayName:"Input",props:{autoComplete:{defaultValue:{value:'"off"',computed:!1},description:"",type:{name:"string"},required:!1},autoFocus:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},description:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},disabled:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},icon:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"string"},required:!1},id:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"string"},required:!1},innerRef:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"union",value:[{name:"object"},{name:"func"}]},required:!1},label:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},margin:{defaultValue:{value:'"a-0"',computed:!1},description:"",type:{name:"string"},required:!1},name:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},onKeyPress:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1},placeholder:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},readOnly:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},reference:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"union",value:[{name:"object"},{name:"func"}]},required:!1},type:{defaultValue:{value:'"text"',computed:!1},description:"",type:{name:"enum",value:[{value:'"number"',computed:!1},{value:'"password"',computed:!1},{value:'"text"',computed:!1}]},required:!1}}};const useKeyboardActions=props=>{const{onClose,onConfirm}=props,handleKeyDown=event=>{switch(event.key){case"Enter":"function"==typeof onConfirm&&onConfirm();break;case"Escape":"function"==typeof onClose&&onClose()}};return(0,react.useEffect)((()=>(window.addEventListener("keydown",handleKeyDown),()=>{window.removeEventListener("keydown",handleKeyDown)})),[]),null};useKeyboardActions.propTypes={onClose:prop_types.PropTypes.func,onConfirm:prop_types.PropTypes.func},useKeyboardActions.defaultProps={onClose:()=>{},onConfirm:()=>{}};const Modal_styles_Styles={ButtonsWrapper:(0,styled_components_browser_esm.Ay)("div")`
  text-align: right;
...
`,PanelWrapper:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>styled_components_browser_esm.AH`
    ...
    width: 100%;
  `}
`},Modal=props=>{const{cancelButton,confirmButton,onClose,show}=props,[showModal,setShowModal]=(0,react.useState)(!1),showModalRef=(0,react.useRef)(!1),handleCancel=()=>{showModalRef.current&&(cancelButton.onClick(),onClose(),setShowModal(!1))},handleClose=()=>{showModalRef.current&&(onClose(),setShowModal(!1))},handleConfirm=()=>{showModalRef.current&&(confirmButton.onClick(),onClose(),setShowModal(!1))};return useKeyboardActions({onClose:handleClose,onConfirm:handleConfirm}),(0,react.useEffect)((()=>{setShowModal(show)}),[show]),(0,react.useEffect)((()=>{showModalRef.current=showModal}),[showModal]),showModal?(0,jsx_runtime.jsx)(Modal_styles_Styles.Overlay,{children:(0,jsx_runtime.jsx)(Modal_styles_Styles.PanelWrapper,{width:props.width,children:(0,jsx_runtime.jsxs)(src.Zk,{padding:"a-20",children:[(0,jsx_runtime.jsx)(Modal_styles_Styles.CloseBtnWrapper,{children:(0,jsx_runtime.jsx)(src.K0,{icon:{name:"times"},onClick:handleClose})}),(0,jsx_runtime.jsx)(Modal_styles_Styles.ContentBox,{$padding:"r-28",children:props.children}),(0,jsx_runtime.jsxs)(Modal_styles_Styles.ButtonsWrapper,{children:[!props.cancelButton.hide&&(0,jsx_runtime.jsx)(src.$n,{kind:"outlined",onClick:handleCancel,children:props.cancelButton.text}),!props.confirmButton.hide&&(0,jsx_runtime.jsx)(src.$n,{margin:"l-8",onClick:handleConfirm,children:props.confirmButton.text})]})]})})}):null};Modal.propTypes={cancelButton:prop_types_default().shape({hide:prop_types_default().bool,onClick:prop_types_default().func,text:prop_types_default().string}),children:prop_types_default().node,confirmButton:prop_types_default().shape({hide:prop_types_default().bool,onClick:prop_types_default().func,text:prop_types_default().string}),onClose:prop_types_default().func,show:prop_types_default().bool,width:prop_types_default().string},Modal.defaultProps={cancelButton:{hide:!1,onClick:()=>{},text:"Cancelar"},children:null,confirmButton:{hide:!1,onClick:()=>{},text:"Continuar"},onClose:()=>{},show:!1,width:"auto"},Modal.__docgenInfo={description:"",methods:[],displayName:"Modal",props:{cancelButton:{defaultValue:{value:'{\r\n  hide: false,\r\n  onClick: () => {},\r\n  text: "Cancelar",\r\n}',computed:!1},description:"",type:{name:"shape",value:{hide:{name:"bool",required:!1},onClick:{name:"func",required:!1},text:{name:"string",required:!1}}},required:!1},children:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"node"},required:!1},confirmButton:{defaultValue:{value:'{\r\n  hide: false,\r\n  onClick: () => {},\r\n  text: "Continuar",\r\n}',computed:!1},description:"",type:{name:"shape",value:{hide:{name:"bool",required:!1},onClick:{name:"func",required:!1},text:{name:"string",required:!1}}},required:!1},onClose:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1},show:{defaultValue:{value:"false",computed:!1},description:"",type:{name:"bool"},required:!1},width:{defaultValue:{value:'"auto"',computed:!1},description:"",type:{name:"string"},required:!1}}};const Panel_styles_Styles={ContentWrapper:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>styled_components_browser_esm.AH`
    flex-grow: 1;
...
`,Wrapper:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>`\n    ${(0,spacing.O)(props)}\n  `}
`},DesktopTable=props=>{const{columns,data,desktopColumns,margin,name,onClick}=props,list=desktopColumns.length>0?desktopColumns:columns.length?columns:[];return(0,jsx_runtime.jsxs)(DesktopTable_styles_Styles.Wrapper,{$margin:margin,children:[(0,jsx_runtime.jsx)(DesktopTable_styles_Styles.Row,{$isHeader:!0,children:list.map(((column,idxC)=>(0,jsx_runtime.jsx)(DesktopTable_styles_Styles.Column,{width:column.width,children:(0,jsx_runtime.jsx)(Text,{type:"bodySemibold",children:column.label})},`table-${name}-row-title-column-${idxC}`)))}),data.map(((row,idxR)=>(0,jsx_runtime.jsx)(DesktopTable_styles_Styles.Row,{onClick:()=>onClick&&onClick(row),children:list.map(((column,idxC)=>(0,jsx_runtime.jsx)(DesktopTable_styles_Styles.Column,{width:column.width,children:column.content(row)},`table-${name}-row-${idxR}-column-${idxC}`)))},`table-row-${idxR}`)))]})};DesktopTable.displayName="DesktopTable",DesktopTable.propTypes={columns:prop_types_default().array,data:prop_types_default().array.isRequired,desktopColumns:prop_types_default().array,margin:prop_types_default().string,name:prop_types_default().string,onClick:prop_types_default().func},DesktopTable.defaultProps={columns:[],data:[],desktopColumns:[],margin:"a-0",name:"",onClick:()=>{}},DesktopTable.__docgenInfo={description:"",methods:[],displayName:"DesktopTable",props:{columns:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},data:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},desktopColumns:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},margin:{defaultValue:{value:'"a-0"',computed:!1},description:"",type:{name:"string"},required:!1},name:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},onClick:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1}}};const PhoneTable_styles_Styles={Column:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>`\n    display: ${props.mobile?.inline?"inline-block":"block"};\n    width: ${props.mobile?.width?props.mobile.width:"100%"};\n  `};
`,Row:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>`\n    border-bottom-color: ${props.theme.colors.black._400};\n    border-bottom-style: solid;\n    border-bottom-width: ${props.theme.components.table.row.borderBottom.width};\n    box-sizing: content-box;\n    padding: ${props.theme.components.table.row.padding};\n\n    &:hover {\n      background-color: ${props.theme.colors.black._200};\n    }\n\n    &:hover&:active {\n      background-color: ${props.theme.colors.black._300};\n    }\n  `};
`,Wrapper:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>`\n    ${(0,spacing.O)(props)}\n  `}
`},PhoneTable=props=>{const{columns,data,mobileColumns,margin,name,onClick}=props,list=mobileColumns.length>0?mobileColumns:columns.length?columns:[];return(0,jsx_runtime.jsx)(PhoneTable_styles_Styles.Wrapper,{$margin:margin,children:data.map(((row,idx)=>(0,jsx_runtime.jsx)(PhoneTable_styles_Styles.Row,{onClick:()=>onClick&&onClick(row),children:list.map(((column,idx)=>(0,jsx_runtime.jsxs)(PhoneTable_styles_Styles.Column,{mobile:column.mobile,children:[(0,jsx_runtime.jsx)(Text,{type:"bodySemibold",children:column.label}),column.content(row)]},`table-${name}-column-${idx}`)))},`table-${name}-row-${idx}`)))})};PhoneTable.displayName="PhoneTable",PhoneTable.propTypes={columns:prop_types.PropTypes.array.isRequired,data:prop_types.PropTypes.array.isRequired,margin:prop_types.PropTypes.string,mobileColumns:prop_types.PropTypes.array,name:prop_types.PropTypes.string,onClick:prop_types.PropTypes.func},PhoneTable.defaultProps={columns:[],data:[],margin:"a-0",mobileColumns:[],name:"",onClick:()=>{}},PhoneTable.__docgenInfo={description:"",methods:[],displayName:"PhoneTable",props:{columns:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},data:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},margin:{defaultValue:{value:'"a-0"',computed:!1},description:"",type:{name:"string"},required:!1},mobileColumns:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},name:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},onClick:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1}}};const Table=props=>{const size=(0,useWindowSize.l)(),theme=(0,styled_components_browser_esm.DP)();return size.width>theme.breakpoints.mobile?(0,jsx_runtime.jsx)(DesktopTable,{columns:props.columns,data:props.data,desktopColumns:props.desktopColumns,margin:props.margin,name:props.name,onClick:props.onClick}):(0,jsx_runtime.jsx)(PhoneTable,{columns:props.columns,data:props.data,margin:props.margin,mobileColumns:props.mobileColumns,name:props.name,onClick:props.onClick})};Table.displayName="Table",Table.propTypes={columns:prop_types_default().array.isRequired,data:prop_types_default().array.isRequired,desktopColumns:prop_types_default().array,margin:prop_types_default().string,mobileColumns:prop_types_default().array,name:prop_types_default().string,onClick:prop_types_default().func},Table.defaultProps={columns:[],data:[],desktopColumns:[],margin:"a-0",mobileColumns:[],name:"",onClick:()=>{}},Table.__docgenInfo={description:"",methods:[],displayName:"Table",props:{columns:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},data:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},desktopColumns:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},margin:{defaultValue:{value:'"a-0"',computed:!1},description:"",type:{name:"string"},required:!1},mobileColumns:{defaultValue:{value:"[]",computed:!1},description:"",type:{name:"array"},required:!1},name:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1},onClick:{defaultValue:{value:"() => {}",computed:!1},description:"",type:{name:"func"},required:!1}}};const Tab=props=>{const{children}=props;return(0,jsx_runtime.jsx)("div",{children})};Tab.displayName="Tab",Tab.propTypes={children:prop_types_default().node,name:prop_types_default().string},Tab.defaultProps={children:null,name:""},Tab.__docgenInfo={description:"",methods:[],displayName:"Tab",props:{children:{defaultValue:{value:"null",computed:!1},description:"",type:{name:"node"},required:!1},name:{defaultValue:{value:'""',computed:!1},description:"",type:{name:"string"},required:!1}}};const Tabs_styles_Styles={TabsBar:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>styled_components_browser_esm.AH`
...
`},UploadFileBox_UploadFileBox=props=>{const{accept,maxSize}=props,ctx=useDropzoneContext();return(0,jsx_runtime.jsxs)(UploadFileBox_styles_Styles.UploadFileBox,{onDragOver:ctx.handleDragOver,onDrop:ctx.handleDrop,children:[(0,jsx_runtime.jsx)(atoms.In,{color:"black_400",icon:"cloud-arrow-up",margin:"b-8",size:"xl"}),(0,jsx_runtime.jsx)(atoms.EY,{align:"center",color:"black_600",type:"subtitle",children:"Arrastre aquí o haga click para cargar archivos"}),(accept.length>0||0!==maxSize)&&(0,jsx_runtime.jsxs)(atoms.EY,{margin:"t-16",align:"center",children:[accept.length>0&&(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:["Se aceptan:"," ",(0,jsx_runtime.jsx)(atoms.EY,{as:"span",type:"bodySemibold",children:(array=accept,array.map((type=>"image"===type?"imágenes":type))).join(", ")})]}),accept.length>0&&0!==maxSize&&" | ",0!==maxSize&&(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:["Tamñano máximo:"," ",(0,jsx_runtime.jsx)(atoms.EY,{as:"span",type:"bodySemibold",children:convertBytes(maxSize)})]})]}),(0,jsx_runtime.jsx)(UploadFileBox_styles_Styles.FileInput,{accept:fileTypesString(accept),multiple:!0,onChange:ctx.handleFileChange,type:"file"})]});var array};UploadFileBox_UploadFileBox.displayName="UploadFileBox",UploadFileBox_UploadFileBox.__docgenInfo={description:"",methods:[],displayName:"UploadFileBox"};const ErrorsList=()=>{const ctx=useDropzoneContext();return(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[ctx.countMaxSizeError>0&&(0,jsx_runtime.jsxs)(atoms.Zk,{margin:"t-16",type:"error",children:[ctx.countMaxSizeError," ",ctx.countMaxSizeError>1?"archivos superan":"archivo supera","  el tamaño máximo permitido."]}),ctx.countErrors>0&&(0,jsx_runtime.jsxs)(atoms.Zk,{margin:"t-8",type:"error",children:[ctx.countErrors," ",ctx.countErrors>1?"archivos tienen":"archivo tiene","  un formato inváido."]}),ctx.maxFileError&&(0,jsx_runtime.jsx)(atoms.Zk,{margin:"t-8",type:"error",children:"Se ha superado la cantidad máxima de archivos."})]})};ErrorsList.__docgenInfo={description:"",methods:[],displayName:"ErrorsList"};const FileItem_styles_Styles={FileItem:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>styled_components_browser_esm.AH`
    ...
    width: 100%;
  `}
`},FileItem_FileItem=props=>{const{file,idx}=props,ctx=useDropzoneContext();return(0,jsx_runtime.jsxs)(FileItem_styles_Styles.FileItem,{children:[(0,jsx_runtime.jsxs)(layout.so,{children:[(0,jsx_runtime.jsx)(atoms.In,{color:"black_600",icon:"file",margin:"r-16"}),(0,jsx_runtime.jsxs)("div",{children:[(0,jsx_runtime.jsx)(atoms.EY,{children:props.file.name}),(0,jsx_runtime.jsx)(atoms.EY,{type:"captionRegular",children:convertBytes(file.size)})]})]}),(0,jsx_runtime.jsx)(atoms.K0,{icon:{name:"close"},onClick:()=>{ctx.deleteSelectedFiles(idx)}})]})};FileItem_FileItem.displayName="FileItem",FileItem_FileItem.__docgenInfo={description:"",methods:[],displayName:"FileItem"};const FilesList=props=>{const{name}=props,ctx=useDropzoneContext();return ctx.selectedFiles.length>0?(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:ctx.selectedFiles.map(((file,idx)=>(0,jsx_runtime.jsx)(FileItem_FileItem,{file,idx},`dropzone-${name}-file-${idx}`)))}):null};FilesList.__docgenInfo={description:"",methods:[],displayName:"FilesList"};const Dropzone_styles_Styles={Wraper:(0,styled_components_browser_esm.Ay)("div")`
  ${props=>styled_components_browser_esm.AH`
    ${(0,spacing.O)(props)}
  `}
`},defaultProps={accept:[],margin:"a-0",maxCount:0,maxSize:0,name:"",validTypes:[]},Dropzone=props=>{const attrs={...defaultProps,...props};return(0,jsx_runtime.jsx)(DropzoneProvider,{accept:attrs.accept,maxCount:attrs.maxCount,maxSize:attrs.maxSize,children:(0,jsx_runtime.jsxs)(Dropzone_styles_Styles.Wraper,{$margin:attrs.margin,children:[(0,jsx_runtime.jsx)(UploadFileBox_UploadFileBox,{accept:attrs.accept,maxSize:attrs.maxSize}),(0,jsx_runtime.jsx)(ErrorsList,{}),(0,jsx_runtime.jsx)(FilesList,{name:attrs.name})]})})};Dropzone.displayName="Dropzone",Dropzone.propTypes={accept:prop_types_default().array,margin:prop_types_default().string,maxCount:prop_types_default().number,maxSize:prop_types_default().number,name:prop_types_default().string},Dropzone.__docgenInfo={description:"",methods:[],displayName:"Dropzone",props:{accept:{description:"",type:{name:"array"},required:!1},margin:{description:"",type:{name:"string"},required:!1},maxCount:{description:"",type:{name:"number"},required:!1},maxSize:{description:"",type:{name:"number"},required:!1},name:{description:"",type:{name:"string"},required:!1}}};const ImageGroup_styles_Wrapper=(0,styled_components_browser_esm.Ay)("div")`
...
//# sourceMappingURL=691.b985dff5.iframe.bundle.js.map