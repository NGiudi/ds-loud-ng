...
`,ImageGroup_styles_Styles={ImageItem:(0,styled_components_browser_esm.Ay)("img")`
  ${props=>styled_components_browser_esm.AH`
      ...
      width: 40px;
    `}
`,Wrapper:ImageGroup_styles_Wrapper},ImageGroup_DEFAULT_PROPS={images:[],margin:"a-0",max:3,name:""},ImageGroup=props=>{const attrs={...ImageGroup_DEFAULT_PROPS,...props},displayedImages=attrs.images.slice(0,attrs.max),extras=attrs.images.length-attrs.max;return(0,jsx_runtime.jsxs)(layout.so,{margin:attrs.margin,children:[(0,jsx_runtime.jsx)(ImageGroup_styles_Styles.Wrapper,{$quantity:displayedImages.length,children:displayedImages.map(((image,idx)=>(0,jsx_runtime.jsx)(ImageGroup_styles_Styles.ImageItem,{alt:image.alt,$idx:idx,src:image.img},`${attrs.name}-inage-${idx}-group`)))}),extras>0&&(0,jsx_runtime.jsxs)(atoms.EY,{as:"span",margin:"l-10",type:"subtitle",children:["+",extras]})]})};ImageGroup.__docgenInfo={description:"",methods:[],displayName:"ImageGroup",props:{images:{description:"",type:{name:"array"},required:!1},margin:{description:"",type:{name:"string"},required:!1},max:{description:"",type:{name:"number"},required:!1},name:{description:"",type:{name:"string"},required:!0}}};const PaginateButton_styles_Styles={Wrapper:(0,styled_components_browser_esm.Ay)("div")`
  margin: 0 4px;
  width: 40px;
...
//# sourceMappingURL=773.dea97e05.iframe.bundle.js.map